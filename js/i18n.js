...
const I18N_TRANSLATIONS = {
  uz: {
    ...
    hero_title: "Respublikada faoliyat yuritayotgan malakali agronomlar RO‘YXATI",
    ...
    th_region: "Hudud",
    th_district: "Tuman",
    th_fullname: "Malakali agronom: F.I.SH.",
    th_phone: "Telefon raqami",
    th_birth: "Tug‘ilgan yili",
    th_spec: "Mutaxassisligi",
    ...
    lbl_region: "Hudud",
    lbl_district: "Tuman",
    lbl_fullname: "Malakali agronom: Familiya, ismi va otasining ismi",
    lbl_phone: "Telefon raqami",
    lbl_birth: "Tug‘ilgan yili",
    lbl_spec: "Mutaxassisligi",
    lbl_university: "Tamomlagan o‘quv yurti",
    lbl_grad_year: "Tamomlagan yili",
    ...
    dropzone_desc: "Excel (.xlsx, .xls), CSV yoki JSON fayllar qo‘llab-quvvatlanadi (Maks: 10MB)",
